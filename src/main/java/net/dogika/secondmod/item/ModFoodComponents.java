...
public class ModFoodComponents {
    public static final FoodComponent ENCHANTED_EMERALD_APPLE = new FoodComponent.Builder()
            ...
            .statusEffect(new StatusEffectInstance(ModEffects.EMERALD_FEVER, 1200, 0, false, false), 0.5F)
            .alwaysEdible()
            .build();
    public static final FoodComponent EMERALD_APPLE = new FoodComponent.Builder()
            ...
            .statusEffect(new StatusEffectInstance(ModEffects.EMERALD_FEVER, 1200, 0, false, false), 1.0F)
            .alwaysEdible()
            .build();
